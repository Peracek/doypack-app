...
export async function getAttempts(orderId: number): Promise<Attempt[]> {
  const result = await pool.query<Attempt>(
    `SELECT id, outcome, created_at,
            ...
            side_e_temperature_c, side_e_temperature_upper_c, side_e_temperature_lower_c, side_e_pressure_bar, side_e_dwell_time_s,
            side_d_temperature_c, side_d_temperature_upper_c, side_d_temperature_lower_c, side_d_pressure_bar, side_d_dwell_time_s,
            side_c_temperature_c, side_c_temperature_upper_c, side_c_temperature_lower_c, side_c_pressure_bar, side_c_dwell_time_s,
            side_b_temperature_c, side_b_temperature_upper_c, side_b_temperature_lower_c, side_b_pressure_bar, side_b_dwell_time_s,
            side_a_temperature_c, side_a_temperature_upper_c, side_a_temperature_lower_c, side_a_pressure_bar, side_a_dwell_time_s,
            note
     FROM attempts
     WHERE order_id = $1
  ...
  try {
    const result = await pool.query<Attempt>(
      `INSERT INTO attempts (
        ...
        zipper_temperature_c, zipper_pressure_bar, zipper_dwell_time_s,
        bottom_temperature_c, bottom_pressure_bar, bottom_dwell_time_s,
        side_e_temperature_upper_c, side_e_temperature_lower_c, side_e_pressure_bar, side_e_dwell_time_s,
        side_d_temperature_upper_c, side_d_temperature_lower_c, side_d_pressure_bar, side_d_dwell_time_s,
        side_c_temperature_upper_c, side_c_temperature_lower_c, side_c_pressure_bar, side_c_dwell_time_s,
        side_b_temperature_upper_c, side_b_temperature_lower_c, side_b_pressure_bar, side_b_dwell_time_s,
        side_a_temperature_upper_c, side_a_temperature_lower_c, side_a_pressure_bar, side_a_dwell_time_s,
        note
      )
