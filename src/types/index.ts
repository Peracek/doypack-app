...
export interface Attempt {
  ...
  side_e_setup: 'iron-iron' | 'iron-silicon' | 'silicon-iron' | null;
  ...
  side_d_setup: 'iron-iron' | 'iron-silicon' | 'silicon-iron' | null;
  ...
  side_c_setup: 'iron-iron' | 'iron-silicon' | 'silicon-iron' | null;
  ...
  side_b_setup: 'iron-iron' | 'iron-silicon' | 'silicon-iron' | null;
  ...
  side_a_setup: 'iron-iron' | 'iron-silicon' | 'silicon-iron' | null;
...
export const MATERIAL_OPTIONS = [
  ...
  'PET TRA/LDPE (MAT-02675)',
  'BOPP MAT/CPP WH (MAT-02619 + MAT-2668)',
];
